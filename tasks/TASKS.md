...
6) + Define Core Agent Terminology and Principles
   ...
   Notes: Plan updated to conform with docs/PLAN_SPECIFICATION.md. Added test-writing features (6.5–6.8) in tasks/6/plan_6.md to validate the produced documentation and deprecations. Refined docs/AGENT_PRINCIPLES.md to include an "Agent vs Orchestrator" subsection per 6.6 test acceptance.
