...
10) + Agent personas
   ...
   Notes: See `docs/AGENT_PERSONAS.md` for persona prompts, minimal context per persona, and usage instructions. VERY IMPORTANT: The personas must work with minimal context needed for them to succeed. We must have all the tools in place for them to succeed at this.
